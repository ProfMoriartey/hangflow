      ...
      <div className="flex flex-row justify-center mb-14 w-3/5 max-sm:w-full">
        ...
        <div className=" w-52 mt-5 sm:static sm:visible"> 
          <Link
              ...
              target="_blank"
              className="group text-black text-sm border border-black mr-2.5 px-6 py-3 flex align-middle items-center gap-4 rounded-full outline-none focus:scale-110 hover:scale-110 hover:bg-white-400 active:scale-105 transition dark:bg-gray-900 dark:border-gray-50 dark:text-gray-50 dark:text-opacity-90 "
          ...
          height={0}
          sizes="90vw"
          style={{ width: '15%', height: 'auto', textAlign: 'center' }}
          quality="95"
          priority={true}
          className="z-5 sm:-ml-3 w-40 invisible sm:visible"
        />
      </div>
      <Image
          src="/apply_flow.png"
          ...
          quality="95"
          priority={true}
          className="z-5 sm:-ml-3 w-40 visible sm:invisible"
        />
